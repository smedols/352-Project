...

{
    ...
    ADC0_SSCTL3_R |= 6; /* take one sample at a time, set flag at 1st sample */
    ADC0_ACTSS_R |= 8; /* enable ADC1 sequencer 3 */
    ...
    while (1)
    {
        ...
        //Map digitized values(0-4095) of input voltage(3.3V) with respect to our fan RPM (incomplete)
        /*
